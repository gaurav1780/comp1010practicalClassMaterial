package week09.builtInLists.testsAttempts;
...
import week09.builtInLists.attempts.*;
...
class Stage3Test {
	...
	@Test
	void testCountItemsOccurringOnlyOnce() {
		assertEquals(0, Stage3.countItemsOccurringOnlyOnce(null));
		...
		assertEquals(0, Stage3.countItemsOccurringOnlyOnce(multi1));
		assertEquals(1, Stage3.countItemsOccurringOnlyOnce(multi2));
		assertEquals(10, Stage3.countItemsOccurringOnlyOnce(multi3));
		assertEquals(8, Stage3.countItemsOccurringOnlyOnce(multi4));

		ArrayList<ArrayList<Integer>> multi5 = new ArrayList<ArrayList<Integer>>(Arrays.asList(null, null, null, null, null));	     
		assertEquals(0, Stage3.countItemsOccurringOnlyOnce(multi5));
	}
