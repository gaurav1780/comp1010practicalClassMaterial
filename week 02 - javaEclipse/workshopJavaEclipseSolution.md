...
1. **CORRECT ANSWER**: `public class Hello {`
...
3. **CORRECT ANSWER**: `public static void main(String[] tom)`
...
public class AverageSpeedCalculator {
	public static void main(String[] args) {
		...
		double timeAToB = distanceAB/speedAToB;
		double timeBToA = distanceAB/speedBToA; 
		
		//total distance travelled
		double totalReturnTripDistance = distanceAB * 2; 

		//total time taken
		double totalReturnTripTimeTaken = timeAToB + timeBToA; 
		
		double averageSpeed =  totalReturnTripDistance / totalReturnTripTimeTaken;
