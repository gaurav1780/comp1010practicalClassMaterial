...
public class Stage2 {
	...
	public boolean twoOutOfThree(int a, int b, int c) {
		//return true:
			//a,b are the same and c is different
			//a,c are the same and b is different
			//b,c are the same and a is different
		...
		//control reaches this line: none of the above three cases
		return false;
