...
public class Stage2 {
	 ...
	 * return 0 if array is null.
	 */
	public int sumBetweenIndices(int[] data, int startIndex, int endIndex) {
		return 0; //to be completed
	} 
	 ...
	 * return 0 if array is null.
	 */
	public int sumEvenFromIndex(int[] data, int startIndex) {
		return 0; //to be completed
	}
	 ...
	 * return 0 if array is null.
	 */
	public int sumOddUptoIndex(int[] data, int endIndex) {
		return 0; //to be completed
	}
	 ...
	 */
	public int productPositivesUptoIndex(int[] data, int endIndex) {
		return 0; //to be completed
	}
	 ...
	 */
	public int productNegativesFromIndex(int[] data, int startIndex) {
		return 0; //to be completed
	}
	 ...
	 */
	public int countOccurrencesBetweenIndices(int[] data, int key, int startIndex, int endIndex) {
		return 0; //to be completed
	}
	 ...
	 */
	public int countUniqueBetweenIndices(int[] data, int startIndex, int endIndex) {
		return 0; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean allNegatives(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean allZeroes(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean allNonZeroes(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean allPrimes(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean containsPositive(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean containsNegative(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean containsZero(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean containsNonZero(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean containsPrime(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean isAscending(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean isDescending(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if the array is null.
	 */
	public boolean isUnchanged(int[] data) {
		return false; //to be completed
	}
	 ...
	 */
	public int getSortedOrder(int[] data) {
		return 0; //to be completed
	}
	 ...
	 * return false if array is null.
	 */
	public boolean isBalanced(int[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if array is null.
	 */
	public boolean allDigits(char[] data) {
		return false; //to be completed
	}
	 ...
	 * return false if array is null.
	 */
	public boolean containsDigit(char[] data) {
		return false; //to be completed
	}
