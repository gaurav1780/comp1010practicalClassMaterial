package testsAttempts.customBuiltArrayList;
...
import attempts.customBuiltArrayList.*;

class CustomArrayListTest {
	private CustomArrayList emptyList, list1, list2, list3;
	...
	@Test
	void testReplaceAll() {
		assertNotNull(list1.replaceAll(3, 12));
		assertEquals("[]",list1.replaceAll(3, 12).toString());
		assertNotNull(list1.replaceAll(10, 70));
		assertEquals("[0]",list1.replaceAll(10, 70).toString());
		assertEquals("[70, 70, 20, 90]",list1.toString());
		assertEquals("[2]",list1.replaceAll(20, 70).toString());
		assertEquals("[70, 70, 70, 90]",list1.toString());
		assertEquals("[3]",list1.replaceAll(90, 70).toString());
		assertEquals("[70, 70, 70, 70]",list1.toString());
		assertEquals("[0, 1, 2, 3]",list1.replaceAll(70, 0).toString());
