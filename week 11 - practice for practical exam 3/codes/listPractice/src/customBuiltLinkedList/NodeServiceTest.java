...
class NodeServiceTest {
	...
	void testSort() {
		...
		Node f1 = new Node(49, null);
		Node e1 = new Node(36, f1);
		Node d1 = new Node(25, e1);
		Node c1 = new Node(17, d1);
		Node b1 = new Node(0, c1);
		Node a1 = new Node(-12, b1);
		// -12 -> 0 -> 17 -> 25 -> 36 -> 49 -> null
		NodeService.sort(a, true);
		assertEquals(a1.getData(), a.getData());
		assertEquals(c1.getData(), a.getNext().getNext().getData());
		assertEquals(f1.getData(), a.getNext().getNext().getNext().getNext().getNext().getData());
		
		Node d2 = new Node(31, null);
		Node c2 = new Node(71, d2);
		Node b2 = new Node(-1, c2);
		Node a2 = new Node(0, b2);
		// 0 -> -1 -> 71 -> 31 -> null
		
		Node d3 = new Node(-1, null);
		Node c3 = new Node(0, d3);
		Node b3 = new Node(31, c3);
		Node a3 = new Node(71, b3);
		// 71 -> 31 -> 0 -> -1 -> null
		NodeService.sort(a2, false);
		assertEquals(a3.getData(), a2.getData());
		assertEquals(c3.getData(), a2.getNext().getNext().getData());
		assertEquals(d3.getData(), a2.getNext().getNext().getNext().getData());
		
		Node a4 = new Node(-1, null);
		Node a5 = new Node(-1, null);
		NodeService.sort(a4, true);
		assertEquals(a5.getData(), a4.getData());
		
		Node a6 = null;
		NodeService.sort(a6, false);
