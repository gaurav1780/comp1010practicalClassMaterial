package testsSolutions.customBuiltLinkedList;
...
import solutions.customBuiltLinkedList.*;

class MyLinkedListTest {
	private MyLinkedList emptyList, singleItemList, list1, list2;
	...
	void testRemove() {
		...
		assertEquals("Empty", singleItemList.toString());
	...
	void testJoin() {
		...
		assertEquals("Empty", emptyList.join(emptyList2).toString());
