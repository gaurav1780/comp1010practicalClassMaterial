package week09.builtInLists.attempts;
import java.util.*;
...
public class Stage3 {
	...
	/**
	 * 
	 * @param list: am arraylist of arraylists of integers
	 * @return the number of items that occur only once within each sub-list.
	 * 
	 * return 0 if data is null or empty
	 */
	public static int countItemsOccurringOnlyOnce(ArrayList<ArrayList<Integer>> list) {
		return 0; //to be completed
	}
